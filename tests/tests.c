...
// As makefile dos not link all src/ files expect main.c for the tests directory
...
void test_resident_db_insert()
{
	...
	printf(
		...
		test_gender == 0 ? "Gender Other" : test_gender == 1 ? "Gender Male" : "Gender Female"
	);
...
void test_foodbatch_db_insert()
{
    ...
    printf(
        ...
        test_batch_id, test_name, test_quantity,
        test_is_perishable ? "True" : "False",
        test_expiration_date, test_daily_consumption_rate
    );

    int rc = foodbatch_db_insert(&test_foodbatch_db, test_batch_id, test_name, test_quantity, 
                                test_is_perishable, test_expiration_date, test_daily_consumption_rate);
    ...
    rc = foodbatch_db_insert(&test_foodbatch_db, test_batch_id, test_name, test_quantity, 
                            test_is_perishable, test_expiration_date, test_daily_consumption_rate);
...
void test_foodbatch_db_update()
{
    ...
    int rc = foodbatch_db_update(&test_foodbatch_db, test_batch_id, test_name, test_quantity,
                                test_is_perishable, test_expiration_date, test_daily_consumption_rate);
    ...
    rc = foodbatch_db_update(&test_foodbatch_db, test_batch_id, updated_name, updated_quantity,
                            test_is_perishable, test_expiration_date, test_daily_consumption_rate);
...
void test_foodbatch_db_check_batchid_exists()
{
    ...
    foodbatch_db_insert(&test_foodbatch_db, test_batch_id, test_name, test_quantity, 
                       test_is_perishable, test_expiration_date, test_daily_consumption_rate);
