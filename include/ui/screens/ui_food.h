...
enum food_screen_flags {
    ...
    FLAG_CONFIRM_FOOD_DELETE = 1 << 2, ///< Pending delete confirmation
    FLAG_BATCHID_EXISTS = 1 << 3,      ///< Batch ID already in database
    FLAG_INVALID_FOOD_DATE = 1 << 4,   ///< Invalid expiration date entered
    FLAG_BATCHID_NOT_FOUND = 1 << 5,   ///< Specified batch ID not found
};
